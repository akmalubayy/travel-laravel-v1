                ...
                <div class="row">
                        ...
                        <div class="card card-details">
                            ...
                            <div class="attendee">
                                <table class="table table-responsive-sm text-center">
                                    ...
                                    <tbody>
                                        @forelse ($item->detail as $details)
                                        <tr>
                                            <td>
                                                <img src="https://ui-avatars.com/api/?name={{$details->username}}" height="60" class="rounded-circle">
                                            </td>
                                            <td class="align-middle check-details">
                                                {{$details->username}}
                                            </td>
                                            ...
                                            <td class="align-middle">
                                                {{$details->is_visa ? '30 Days' : 'N/A'}}
                                            </td>
                                            <td class="align-middle">
                                                {{\Carbon\Carbon::createFromDate($details->doe_passport) >
                    ...
                    <div class="col-lg-4">
                        <div class="card card-details card-right">
                            ...
                            <table class="trip-informations">
                                ...
                                <tr>
                                    ...
                                    <td width="50%" class="text-right">
                                        <span class="text-blue text-total">
                        ...
                        <div class="text-center mt-3">
                            <a href="{{route('detail', $item->travel_package->slug)}}" class="text-muted text-cancel">
                                Cancel Booking
                            </a>
                        </div>
                    </div>
